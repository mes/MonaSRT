...
[ -f $INSTALLDIR/libs/libssl.1.0.0.dylib ] && {
	...
	install_name_tool -change /usr/local/Cellar/openssl/1.0.2m/lib/libcrypto.1.0.0.dylib @executable_path/libs/libcrypto.1.0.0.dylib $INSTALLDIR/libs/libssl.1.0.0.dylib
}
